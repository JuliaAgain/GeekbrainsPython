...
while True:
    ...
    if not isinstance(s1, str) or not isinstance(s2, str):
        ...
        break
def shorten(x, y): # функция для сокращения дроби с числителем x и знаменателем y
    divids = []  #в этот пустой список добавим все общие делители числителя и заменателя и найдем из них максимальный
